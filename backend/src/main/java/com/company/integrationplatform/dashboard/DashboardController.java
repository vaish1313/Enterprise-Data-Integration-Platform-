...
@Tag(name = "Dashboard Analytics", description = "APIs for platform-wide analytics and KPI metrics")
public class DashboardController {
    ...
    @Operation(summary = "Get platform analytics summary",
               description = "Returns total imports, success/failure counts, active sources, and last sync time")
