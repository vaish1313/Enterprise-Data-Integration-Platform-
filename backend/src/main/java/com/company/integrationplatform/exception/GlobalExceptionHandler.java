...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.company.integrationplatform.datasource.DataSourceNotFoundException.class)
    public ResponseEntity<ApiResponse<Void>> handleDataSourceNotFound(
            com.company.integrationplatform.datasource.DataSourceNotFoundException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleIngestion(IngestionException ex) {
