-- V8__full_demo_seed_data.sql
-- EDIP — Seed Data (verified against live schema)
-- Additive migration containing full demo dataset.
...
(gen_random_uuid(), NOW()-INTERVAL '10 days', NOW(), 'cccccccc-0006-0000-0000-000000000006', 'bbbbbbbb-0002-0000-0000-000000000002', '{"product_code":"SKU-001","unit_price":"29.99","region":"US","sale_date":"15/05/2026"}', '{"product_code":"sku-001","price":"29.99","region":"US","sale_date_iso":"2026-05-15"}', 'PROCESSED', NULL, NULL, 1, true, 'dddddddd-0001-0000-0000-000000000001'),
(gen_random_uuid(), NOW()-INTERVAL '10 days', NOW(), 'cccccccc-0006-0000-0000-000000000006', 'bbbbbbbb-0002-0000-0000-000000000002', '{"product_code":"SKU-002","unit_price":"49.99","region":"EU","sale_date":"15/05/2026"}', '{"product_code":"sku-002","price":"49.99","region":"EU","sale_date_iso":"2026-05-15"}', 'PROCESSED', NULL, NULL, 2, true, 'dddddddd-0001-0000-0000-000000000001'),
(gen_random_uuid(), NOW()-INTERVAL '10 days', NOW(), 'cccccccc-0006-0000-0000-000000000006', 'bbbbbbbb-0002-0000-0000-000000000002', '{"product_code":"SKU-003","unit_price":"9.99","region":null,"sale_date":"16/05/2026"}', '{"product_code":"sku-003","price":"9.99","region":"UNKNOWN","sale_date_iso":"2026-05-16"}', 'PROCESSED', NULL, NULL, 3, true, 'dddddddd-0001-0000-0000-000000000001'),
(gen_random_uuid(), NOW()-INTERVAL '10 days', NOW(), 'cccccccc-0006-0000-0000-000000000006', 'bbbbbbbb-0002-0000-0000-000000000002', '{"product_code":"SKU-004","unit_price":"N/A","region":"APAC","sale_date":"16/05/2026"}', NULL, 'FAILED', 'Invalid numeric value "N/A" in field unit_price', 'unit_price', 4, false, NULL),
(gen_random_uuid(), NOW()-INTERVAL '7 days', NOW(), 'cccccccc-0014-0000-0000-000000000014', 'bbbbbbbb-0007-0000-0000-000000000007', '{"invoiceRef":"INV-1001","currency":"usd","amount":"1500.00"}', '{"invoice_ref":"INV-1001","currency":"USD","amount":"1500.00"}', 'PROCESSED', NULL, NULL, 1, true, 'dddddddd-0003-0000-0000-000000000003'),
(gen_random_uuid(), NOW()-INTERVAL '7 days', NOW(), 'cccccccc-0014-0000-0000-000000000014', 'bbbbbbbb-0007-0000-0000-000000000007', '{"invoiceRef":"INV-1002","currency":"eur","amount":"890.50"}', '{"invoice_ref":"INV-1002","currency":"EUR","amount":"890.50"}', 'PROCESSED', NULL, NULL, 2, true, 'dddddddd-0003-0000-0000-000000000003'),
(gen_random_uuid(), NOW()-INTERVAL '18 days', NOW(), 'cccccccc-0010-0000-0000-000000000010', 'bbbbbbbb-0004-0000-0000-000000000004', '{"dept_code":"eng","job_title":" Software Engineer ","employee_id":"E001"}', '{"dept_code":"ENG","job_title":"Software Engineer","employee_id":"E001"}', 'PROCESSED', NULL, NULL, 1, true, 'dddddddd-0004-0000-0000-000000000004'),
(gen_random_uuid(), NOW()-INTERVAL '18 days', NOW(), 'cccccccc-0010-0000-0000-000000000010', 'bbbbbbbb-0004-0000-0000-000000000004', '{"dept_code":"hr","job_title":"HR Manager","employee_id":"E002"}', '{"dept_code":"HR","job_title":"HR Manager","employee_id":"E002"}', 'PROCESSED', NULL, NULL, 2, true, 'dddddddd-0004-0000-0000-000000000004'),
(gen_random_uuid(), NOW()-INTERVAL '18 days', NOW(), 'cccccccc-0010-0000-0000-000000000010', 'bbbbbbbb-0004-0000-0000-000000000004', '{"dept_code":"fin","job_title":"Finance Analyst","employee_id":"E003"}', '{"dept_code":"FIN","job_title":"Finance Analyst","employee_id":"E003"}', 'PROCESSED', NULL, NULL, 3, false, NULL),
(gen_random_uuid(), NOW()-INTERVAL '22 days', NOW(), 'cccccccc-0008-0000-0000-000000000008', 'bbbbbbbb-0003-0000-0000-000000000003', '{"campaignId":"C-2001","channel":"email","impressions":"45000","clicks":"1200"}', '{"campaign_id":"C-2001","channel":"EMAIL","impressions":"45000","clicks":"1200"}', 'PROCESSED', NULL, NULL, 1, false, NULL),
(gen_random_uuid(), NOW()-INTERVAL '22 days', NOW(), 'cccccccc-0008-0000-0000-000000000008', 'bbbbbbbb-0003-0000-0000-000000000003', '{"campaignId":"C-2002","channel":"social","impressions":"120000","clicks":"3400"}', '{"campaign_id":"C-2002","channel":"SOCIAL","impressions":"120000","clicks":"3400"}', 'PROCESSED', NULL, NULL, 2, false, NULL)
ON CONFLICT (id) DO NOTHING;
